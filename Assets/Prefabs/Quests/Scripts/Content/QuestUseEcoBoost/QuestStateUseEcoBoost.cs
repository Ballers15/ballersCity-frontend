...
{
    [Serializable]
    public sealed class QuestStateUseEcoBoost : QuestStateEcoClicker
    {
        [SerializeField] 
        ...
        public QuestStateUseEcoBoost(string stateJson) : base(stateJson)
        {
        }

        public QuestStateUseEcoBoost(QuestInfo info) : base(info)
        {
        }
        ...
        public override string GetDescription(Quest quest) {
            return Localization.GetTranslation("ID_Q_START_ECOBOOST");
        }
    }
}