...
namespace DTDEditor {
    public class DTDVisualEditorWindow : EditorWindow {
        ...
        private void DrawNotifications() {
            ...
            EditorGUILayout.LabelField("Firebase Sender Id", new GUIStyle(Styles.MainTextStyle) { padding = new RectOffset(0, 0, 4, 0) }, GUILayout.Width(120));
            ViewModel.PushFirebaseSenderId = EditorGUILayout.TextField(ViewModel.PushFirebaseSenderId, Styles.TextFieldStyle);
            EditorGUILayout.EndHorizontal();
